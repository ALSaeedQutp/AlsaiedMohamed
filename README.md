...
<h2>Latest Newsletter Issues</h2>
  <ul>
    <li><a href=https://weekly-vue.news/issues/v2/189 target="_blank" rel="noreferrer nofollow">Weekly Vue News #225 - Migrating to Nuxt 4, Mastering State, and Embracing New UI Tools</a></li><li><a href=https://weekly-vue.news/issues/v2/188 target="_blank" rel="noreferrer nofollow">Weekly Vue News #224 - Self-Hosted Nuxt Studio, URL-Driven State, and AI-Era TypeScript</a></li><li><a href=https://weekly-vue.news/issues/v2/187 target="_blank" rel="noreferrer nofollow">Weekly Vue News #223 - Mastering Nuxt Layers, Pinia v3, and Image Optimizations</a></li><li><a href=https://weekly-vue.news/issues/v2/186 target="_blank" rel="noreferrer nofollow">Weekly Vue News #222 - Nuxt 4.2 Lands, Nitro v3 Previewed, and Tools to Boost Your Workflow</a></li><li><a href=https://weekly-vue.news/issues/v2/185 target="_blank" rel="noreferrer nofollow">Weekly Vue News #221 - Vapor Mode, Vue Reactivity Quirks & Vitest 4.0 Released</a></li>
  </ul>
